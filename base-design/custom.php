...
<!-- custom body -->
    ...
    <ul class="share-icons">
        <li class="facebook">
            <a class="facebook-share" id="facebook-share" onclick="window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=600');return false;"
                title="Share on Facebook"></a>
            <div class="glyphicon glyphicon-facebook"></div>
        </li>
        <li class="twitter">
            <a id="twitter-share" onclick="window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=400,width=600');return false;"
        ...
        <li class="print">
            <a id="print-share" onclick="window.print();"></a>
            <div class="glyphicon glyphicon-print"></div>
        </li>
    </ul>

    <h1 class="head">Headline lives here</h1>
    <h2 class="deck"><span>This is the story of a deckhead that will grow up to live on this story page</span></h2>

    <p class="byline fancy">By Firstname Lastname</p>
    <p class="pub-date">Month ##, Year 0:00 AM</p>

    <button class="sources-btn">View sources</button>
    <button class="sources-head"></button>


    <div class="note">
        <p><strong>Correction:</strong> Opps, we made a mistake and here's what it is. Needs to give enough context to not confuse the reader since they're just beginning the story.</p>
    </div>

    <p class="intro"><span class="dropcap">B</span>acon ipsum dolor amet ham hock ribeye mollit andouille lorem duis. Sed cillum drumstick consequat biltong laboris. Nostrud et voluptate enim ut, anim qui aliquip est cupim kielbasa aliqua. Culpa occaecat fatback, cow reprehenderit sirloin pork chop pastrami ea elit incididunt sunt andouille. Ex bacon capicola, veniam flank cupim ullamco sint pariatur duis. Brisket fatback tongue pastrami cow swine sunt adipisicing eiusmod turducken duis doner non. Tri-tip pariatur rump meatloaf enim.</p>

    <!-- body copy for local developing -->
    ...
    <p>Proident pork belly leberkas shank bacon, occaecat jowl turducken. Sed eu nulla incididunt jowl, short ribs labore aliquip cillum deserunt anim et swine. Tongue est in pancetta duis pork belly. Frankfurter shoulder ea, aliqua laborum
    id ham hock jowl tenderloin do short ribs ut leberkas rump deserunt. Id aute dolore nulla dolore pork deserunt corned beef picanha nisi.</p>
    ...
    <h4 class="accent-color">This is a subhead</h4>
    ...
    <p>Meatball fatback alcatra, kevin swine kielbasa doner sint eu lorem strip steak elit dolor in. Kielbasa ground round aliqua, strip steak ea landjaeger sunt. Andouille ex quis short loin ball tip prosciutto. Leberkas andouille aliquip
    in cupidatat. Venison corned beef enim adipisicing proident, ground round excepteur cupim id turducken doner.</p>
    ...
    <blockquote>
        <div class="quotemark-desk accent-color">“</div>
        <p class="quote"><span class="quotemark-mob accent-color">“</span>This is a blockquote and lives inline because it always contains new content that is never repeated in the story.</p>
        <div class="attribution">— Firstname Lastname, Title here</div>
    </blockquote>
    ...
    <p>Tongue culpa shank tail ut eiusmod occaecat short ribs ground round leberkas non nulla eu pork belly. Ut cupidatat magna quis culpa kielbasa dolor. Nulla id in sint aute ham tail alcatra sirloin dolore sausage shankle cupidatat velit.
    Turkey laboris eu, sint ground round burgdoggen occaecat ball tip exercitation deserunt pastrami. Salami ground round rump, landjaeger nisi adipisicing hamburger excepteur in drumstick doner aliqua porchetta sirloin. Est dolore
    jerky incididunt excepteur cupim. Shankle voluptate in, biltong jerky meatloaf aliqua commodo bacon alcatra short loin sausage lorem boudin consequat.</p>
    ...
    reprehenderit meatloaf. Leberkas quis sed culpa burgdoggen pork chop chicken adipisicing ad alcatra.</p>

    <p>Ut ipsum duis shoulder, velit laborum pork loin jowl tail non doner fatback. In velit landjaeger, non hamburger sausage tail ex in nostrud id aliquip venison. Dolore magna excepteur quis ut. Cow consequat turkey sed, porchetta ex ground
    round capicola exercitation pork chop adipisicing elit eu in. Cupidatat pancetta alcatra, id lorem laboris jerky non shank drumstick duis t-bone. Eu dolore ham hock capicola bresaola porchetta, ipsum duis ea nostrud biltong sed
    leberkas excepteur.</p>

    <p>Qui rump adipisicing voluptate capicola frankfurter prosciutto occaecat kielbasa ut tongue dolore salami. Andouille ut ad quis. Anim capicola minim frankfurter, labore adipisicing culpa proident do venison brisket jowl sint. Meatloaf
    rump eiusmod pariatur lorem. Nostrud jowl in, capicola est velit esse beef short ribs brisket tongue. Ball tip qui tri-tip bresaola. Exercitation andouille in flank.</p>

    <p>Short loin excepteur venison t-bone salami. Burgdoggen minim enim eiusmod mollit. Adipisicing ex ham cow beef ribs tail porchetta et turkey shank. Picanha rump laborum cupim minim sed beef turkey prosciutto dolor tongue commodo. Boudin
    sed minim ut, rump pork loin bacon ball tip et tail nostrud. Pig doner chuck culpa incididunt. Boudin duis aliquip, non irure dolore mollit kevin leberkas rump culpa ribeye pancetta fatback labore.</p>
    ...
    <!-- <section class="special-section border-top">
        <h3 class="accent-color">About this series</h3>
    ...
    <section class="related-articles clearfix">
        <h1 id="related-heading" class="heading">Suggested for you</h1><br /><br />
